...
export default function Homepage() {
  ...
  return (
    <main className="flex flex-col justify-center bg-nav-color items-center h-full">
      <div className="w-full flex flex-col items-start justify-between gap-5 lg:gap-0 lg:flex-row lg:items-center px-5 lg:px-20 xl:px-44 3xl:px-60 4xl:px-72 mt-5 lg:mt-0">
        <div className="w-full lg:w-[70%] flex flex-col gap-3">
          <div className="w-full text-[2.5rem] leading-[3rem] lg:leading-[4rem] text-black-main lg:text-[2vmax] xl:text-[2.5vmax] font-semibold">
            <p>Empower Open Source with REPOS,</p>
          ...
          <div className="w-full lg:w-[85%] text-[1.2rem] lg:text-xs xl:text-sm 3xl:text-lg">
            <span>
              REPOS (Reimbursed Enhancement Proposals for Open Source) is a
              platform that connects open source developers with sponsors and
              contributors. Whether you want to support existing projects or
              propose new ideas, REPOS provides a sustainable way to fund and
              drive innovation in the open source ecosystem.
            </span>
          </div>
        </div>
      ...
      <div className="w-full flex-col items-center justify-between gap-8 lg:gap-0 bg-white px-8 lg:px-20 xl:px-52 3xl:px-80 py-7">
